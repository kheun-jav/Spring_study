...
public class CountScheduler {
	...
	private int cnt;
	/*
	 * execute1 : 5초마다 실행되는 메서드
	 * @Scheduled(cron="0/5 * * * * ?")
	 * @Scheduled(fixedRate = 5000) : 밀리초 단위. 이전작업의 시작시점부터 고정간격
	 * @Scheduled(fixedDelay = 5000) : 밀리초 단위. 이전작업에 종료시점부터 고정간격
	 */
...
//	@Scheduled(initialDelay=3000,fixedRate = 5000)
	...
	public void execute3 () {
		System.out.println("6월 23일 12시 20분 입니다");
	}
	/*
	 * 1. 평일 아침 10시 30분에 환율 정보를 조회하여 db에 등록하기
	 * 2. exchange 테이블 생성하기
	 *    create table exchange (
	 *    eno int primary key auto_ingrement,	-- 키값
